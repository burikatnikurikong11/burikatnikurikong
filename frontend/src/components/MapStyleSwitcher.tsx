...
function MapStyleSwitcher({ currentStyle, onStyleChange, isMobile = false, isOpen, onClose }: MapStyleSwitcherProps) {
  ...
  const handleStyleClick = (style: MapStyle) => {
    onStyleChange(style)
    onClose() // Close the switcher after selecting
  }
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          top: '64px', // Below the map controls
          right: '20px',
