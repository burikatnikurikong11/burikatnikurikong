  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-12 h-12 flex items-center justify-center transition-all hover:bg-gray-100 border-b"
        style={{
      ...
      <button
        ...
        className="w-12 h-12 flex items-center justify-center transition-all hover:bg-gray-100"
        style={{
          color: 'var(--forest-green)',
        }}
